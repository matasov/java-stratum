...
public interface WorkerConnection extends Connection {
  ...
  /**
   * Set the sampling period to compute the hashrate of the connection. he period is in seconds.
   * 
  ...
  /**
   * Return a read-only map of users/passwords that are authorized on this connection.
   * 
   * @return
   */
