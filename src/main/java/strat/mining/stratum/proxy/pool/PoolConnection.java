...
public class PoolConnection extends StratumConnection {
  ...
  protected void onExtranonceSubscribeRequest(MiningExtranonceSubscribeRequest request) {
    LOGGER.warn("Pool {} received an Extranonce Subscribe request. This should not happen.",
        pool.getName());
  }
  ...
  protected void onGetTransactionsRequest(MiningGetTransactionsRequest request) {
    LOGGER.warn("Pool {} received a GetTransactions request. This should not happen.",
        pool.getName());
  }
